/**
 * DEPRECATED: This component has been replaced with Paper Design Shaders (Warp)
 * 
 * Use instead:
 * import { Warp } from "@paper-design/shaders-react"
 * 
 * See src/app/page.tsx for live implementation example
...
export function SpaceBackground({
  ...
  const [resolvedColor, setResolvedColor] = useState<string>("rgba(255,255,255,0.85)")
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      ctx.fillRect(-canvas.width / ratio, -canvas.height / ratio, canvas.width * 2 / ratio, canvas.height * 2 / ratio)
